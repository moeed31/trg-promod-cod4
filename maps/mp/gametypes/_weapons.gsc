...
dropWeaponForDeath()
{
	...
	if(stockAmmo > stockMax)
		stockAmmo = stockMax;
	// Item does not get defined properly, so the code below will throw runtime errors, but the weapon is properly droped
...
{
	return (weaponname == "colt45_mp" || weaponname == "usp_mp" || weaponname == "beretta_mp" || weaponname == "deserteagle_mp" || weaponname == "deserteaglegold_mp");
}

isgrenade(weaponname)
{
	return (weaponname == "frag_grenade_mp" || weaponname == "frag_grenade_short_mp" || weaponname == "smoke_grenade_mp" || weaponname == "flash_grenade_mp" || weaponname == "concussion_grenade_mp");
}