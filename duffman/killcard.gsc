...
init() 
{
	...
	//------------------------CUSTOM CARDS--------------------
	addDesign("killcard", 0, (1, 1, 1), 0.8, "killcard", 250, 38, "middle", height);
	addDesign("killcard", 1, (1, 1, 1), 0.8, "killcard", 250, 38, "middle", height);

	addDesign("killcard_ct", 0, (1, 1, 1), 0.8, "killcard_ct", 250, 38, "middle", height);
	addDesign("killcard_ct", 1, (1, 1, 1), 0.8, "killcard_ct", 250, 38, "middle", height);

	addDesign("killcard_gl", 0, (1, 1, 1), 0.8, "killcard_gl", 250, 38, "middle", height);
	addDesign("killcard_gl", 1, (1, 1, 1), 0.8, "killcard_gl", 250, 38, "middle", height);

	addDesign("killcard_in", 0, (1, 1, 1), 0.8, "killcard_in", 250, 38, "middle", height);
	addDesign("killcard_in", 1, (1, 1, 1), 0.8, "killcard_in", 250, 38, "middle", height);

	addDesign("killcard_jk", 0, (1, 1, 1), 0.8, "killcard_jk", 250, 38, "middle", height);
	addDesign("killcard_jk", 1, (1, 1, 1), 0.8, "killcard_jk", 250, 38, "middle", height);

	addDesign("killcard_mw", 0, (1, 1, 1), 0.8, "killcard_mw", 250, 38, "middle", height);
	addDesign("killcard_mw", 1, (1, 1, 1), 0.8, "killcard_mw", 250, 38, "middle", height);

	addDesign("killcard_ns", 0, (1, 1, 1), 0.8, "killcard_ns", 250, 38, "middle", height);
	addDesign("killcard_ns", 1, (1, 1, 1), 0.8, "killcard_ns", 250, 38, "middle", height);

	addDesign("killcard_pg", 0, (1, 1, 1), 0.8, "killcard_pg", 250, 38, "middle", height);
	addDesign("killcard_pg", 1, (1, 1, 1), 0.8, "killcard_pg", 250, 38, "middle", height);

	addDesign("killcard_sl", 0, (1, 1, 1), 0.8, "killcard_sl", 250, 38, "middle", height);
	addDesign("killcard_sl", 1, (1, 1, 1), 0.8, "killcard_sl", 250, 38, "middle", height);

	addDesign("killcard_yk", 0, (1, 1, 1), 0.8, "killcard_yk", 250, 38, "middle", height);
	addDesign("killcard_yk", 1, (1, 1, 1), 0.8, "killcard_yk", 250, 38, "middle", height);
...
ShowKillCard(attacker, victim, sMeansOfDeath, sWeapon, sHitLoc) 
{
	if(isDefined(attacker) && isDefined(victim) && isPlayer(attacker) && isPlayer(victim) && attacker != victim && isDefined(sMeansOfDeath) && isDefined(sWeapon) && !isDefined(attacker.pers["isBot"]) && !isDefined(victim.pers["isBot"])) 
	{
		...
		if(!isDefined(attacker GetCurrentWeapon())) 
			return;
		victim thread KillCard(attacker, sWeapon, attacker GetCurrentWeapon(), victim);
		attacker thread KillCard(attacker, sWeapon, attacker GetCurrentWeapon(), victim);
	}
 }
...
KillCard(from, weap, alternatewep, target) 
{
	...
	if(isDefined(target) && self == from)
	{
		shader[3] setValue(target getKillStat(self GetEntityNumber()));
		shader[4] setValue(self getKillStat(target GetEntityNumber()));
	}
	else
	{
...
setWeaponIcon(wep, alternate) 
{
	...
	switch(wep) 
	{
		...
		case "flash": s = "weapon_concgrenade"; x = 40;
			break;
		case "knife": s = "killiconmelee"; x = 43;
			break;
		default: s = "killiconsuicide"; x = 40; y = 40;
			break;
	}
